...
(function($){
	 $.fn.slideControl = function(options) {
		...
		return this.each(function() {
			...
			parent.html("<label>" + $(label).html() + "</label><span class=\"slideControlContainer\"><span class=\"slideControlFill\" style=\"width:" + $(obj).val()*20 + "%\"><span class=\"slideControlHandle\"></span></span></span>" + $(obj).wrap("<span></span>").parent().html());
			...
			$(container).click(function(e) {		
				...
				animate(position);
				$(input).val(parseInt(position/20));
			});
