...
class RegistrarAdminController extends Controller
{
	...
	if( $session->get('userId') && $session->get('userId') != '' && $session->get('type') == 3)
	{
	...
	if ($request->getMethod() == 'POST')
		...
		//find email, password type and status of admin
                $user = $repository->findOneBy(array('username' => $userName, 'password' => $password,'type'=>3,'status'=>1 ));
		$userEmail = $repository->findOneBy(array('email' => $userName, 'password' => $password,'type'=>3,'status'=>1 ));
         	if ($user) 
         	{
	...
	$totalRevenueByAdminYear = $em->createQueryBuilder()
   	->select('count(SearchHistory.id) AS totalRevenueByAdminYear')
   	->from('DRPAdminBundle:Log',  'SearchHistory')
	...
	$totalRevenueByAdminMonth = $em->createQueryBuilder()
   	->select('count(SearchHistory.id) AS totalRevenueByAdminMonth')
   	->from('DRPAdminBundle:Log',  'SearchHistory')
...
';
	...
	{
		 return $this->render('DRPRegistrarAdminBundle:Pages:passwordSuccess.html.twig');	
	...
	public function showUsersAction(Request $request)
	{
		...
		//$html =  $this->render('DRPRegistrarAdminBundle:Pages:users.html.twig',array('users'=>$users));
			return $this->render('DRPRegistrarAdminBundle:Pages:users.html.twig',array('users'=>$arrUser));
	...
	public function editUserAction(Request $request,$id)
	{
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:editUser.html.twig',array('editUser'=>$editUser,'businessType'=>$businessType,'plans'=>$plans,'editCompany'=>$editCompany)); 
	...
	public function showBusinessAction(Request $request)
	{
		...
		->getQuery()
		->getResult();
		return $this->render('DRPRegistrarAdminBundle:Pages:business.html.twig',array('business'=>$business));
	...
	public function addCompanyAction(Request $request)
	{
		...
		if($request->getMethod() == 'POST') 
		{
			...
			$em->persist($addBusiness);
			$em->flush();
			return $this->redirect($this->generateUrl('registrarAdmin_showBusiness'));
		}
			return $this->render('DRPRegistrarAdminBundle:Pages:addCompany.html.twig');
	}	
	...
	public function editCompanyAction(Request $request,$id)
	{
		...
		if($request->getMethod() == 'POST') 
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:editCompany.html.twig',array('business'=>$business));
	}	
	...
	public function editPlanAction(Request $request ,$id)
	{
		...
		if($request->getMethod() == 'POST') 
		{
			...
			return $this->redirect($this->generateUrl('registrarAdmin_showPlans'));
			
		}
		return $this->render('DRPRegistrarAdminBundle:Pages:editPlan.html.twig',array('editPlan'=>$editPlan));
	...
	{	
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:addPlan.html.twig');
	...
	public function userProfileAction(Request $request,$id)
	{
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:userProfile.html.twig',array('userProfile'=>$userProfile,'company'=>$company,'plans'=>$plans,'userPlan'=>$userPlan));
	...
	public function viewCompanyAction(Request $request,$id)
	{
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:viewCompany.html.twig',array('viewCompany'=>$viewCompany));
	...
	public function viewPlanAction(Request $request,$id)
	{
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:viewPlan.html.twig',array('viewPlan'=>$viewPlan));
	...
	public function adminSettingsAction(Request $request,$id)
	{
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:adminSettings.html.twig',array('userInfo'=>$userInfo));
	}
	...
	public function changePasswordAction()
		...
		public function managePaymentsAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:managePayments.html.twig',array('payments'=>$payments));
		...
		public function manageLogsAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:manageLogs.html.twig',array('logs'=>$logs));
		...
		public function deleteLogsAction(Request $request,$id)
		{
			...
			$em->remove($logs);
			$em->flush();
			return $this->redirect($this->generateUrl('registrarAdmin_manageLogs'));
		...
		public function searchQuotaAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:searchQuota.html.twig',array('searchQuota'=>$searchQuota));
		...
		public function instrumentTypeAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:instrumentType.html.twig',array('instrument'=>$instrument));
		...
		public function editInstrumentAction(Request $request,$id)
		{
			...
			if($request->getMethod() == 'POST') 
			{
				...
				$em->flush();
				return $this->redirect($this->generateUrl('registrarAdmin_instrumentType'));
			}

			return $this->render('DRPRegistrarAdminBundle:Pages:editInstrument.html.twig',array('editInstrument'=>$editInstrument));
		...
		public function addInstrumentAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:addInstrument.html.twig');
		...
		public function businessTypeAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:businessType.html.twig',array('business'=>$business));
		...
		public function editBusinessTypeAction(Request $request,$id)
		{
			...
			if($request->getMethod() == 'POST') 
			{
				...
				$em->flush();
				return $this->redirect($this->generateUrl('registrarAdmin_businessType'));
			}

			return $this->render('DRPRegistrarAdminBundle:Pages:editBusinessType.html.twig',array('editBusinessType'=>$editBusinessType));
		...
		{	
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:addBusinessType.html.twig');
		...
		public function registrationTypeAction(Request $request)
		{
			...
			->getQuery()
			->getResult();
			return $this->render('DRPRegistrarAdminBundle:Pages:registrationType.html.twig',array('registrationType'=>$registrationType));
		...
		public function editRegistrationTypeAction(Request $request,$id)
		{
			...
			if($request->getMethod() == 'POST') 
			{
				...
				$em->flush();
				return $this->redirect($this->generateUrl('registrarAdmin_registrationType'));
			}

			return $this->render('DRPRegistrarAdminBundle:Pages:editRegistrationType.html.twig',array('editRegistrationType'=>$editRegistrationType));
		...
		public function addRegistrationTypeAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:addRegistrationType.html.twig');
		...
		public function editLeaseRegistrationTypeAction(Request $request,$id)
		{
			...
			if($request->getMethod() == 'POST') 
			{
				...
				$em->persist($editRegistrationType);
				$em->flush();
				return $this->redirect($this->generateUrl('registrarAdmin_leaseRegistrationType'));
			}

			return $this->render('DRPRegistrarAdminBundle:Pages:editLeaseRegistrationType.html.twig',array('editRegistrationType'=>$editRegistrationType));
		...
		public function addLeaseRegistrationTypeAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:addLeaseRegistrationType.html.twig');
		...
		{	
			...
			if($request->getMethod() == 'POST') 
			{
				...
				if( $emailExistanceCheck == 0 )
				{
					...
					return $this->render('DRPRegistrarAdminBundle:Pages:registrationSuccess.html.twig',array('registrationDetail'=>$registrationDetail));
				}
				else
				{
					return $this->redirect($this->generateUrl('registrarAdmin_login'));
				}
		...
		public function managePropertiesAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:manageProperties.html.twig',array('properties'=>$properties));
...
//echo $newReferenceNumber;die;
				...
				return $this->redirect($this->generateUrl('registrarAdmin_showpdrb',array('code'=>$code,'number'=>$number)));
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:addDrb.html.twig',array('registrationType'=>$registrationType,'instrumentType'=>$InstrumentType,'getType'=>$getType));
		...
		public function editDRBAction(Request $request,$id)
		{
			...
			if($request->getMethod() == 'POST') 
			{
				...
				return $this->render('DRPRegistrarAdminBundle:Pages:editDRB.html.twig',array('editDRB'=>$editDRB,'registrationType'=>$registrationType,'instrumentType'=>$InstrumentType,'lessorType'=>$lessorType,'leaseType'=>$leaseType,'partyRegistring'=>$partyRegistring,'editrecipient'=>$editrecipient,'getType'=>$getType));
...

		{
			...
			$ipAddress = $_SERVER['REMOTE_ADDR'];
				...
				$params['creatorId'] = $session->get('userId');
				$this->setLogAction($params);
			return $this->redirect($this->generateUrl('registrarAdmin_showLease',array('code'=>$user->registration_type,'number'=>$number)));
...

		{
			...
			return $this->redirect($this->generateUrl('registrarAdmin_showpdrb',array('code'=>$user->registration_type,'number'=>$number)));
...
//echo"<pre>";print_r($properties);die;
			return $this->render('DRPRegistrarAdminBundle:Pages:manageLease.html.twig',array('properties'=>$properties));
		...
		{	$session = $this->getRequest()->getSession();
			...
			if($request->getMethod() == 'POST') 
			{
				...
				return $this->render('DRPRegistrarAdminBundle:Pages:editLease.html.twig',array('editLease'=>$editLease,'registrationType'=>$registrationType,'lessorType'=>$lessorType,'leaseType'=>$leaseType,'partyRegistring'=>$partyRegistring,'editrecipient'=>$editrecipient,'getType'=>$getType));
		...
		public function deletePaymentAction(Request $request,$id)
		{
			...
			$em->remove($user);
			$em->flush();
			return $this->redirect($this->generateUrl('registrarAdmin_managePayments'));
		...
		public function viewDRBAction(Request $request,$id)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:viewDRB.html.twig',array('viewDRB'=>$viewDRB,'viewLessor'=>$viewLessor,'viewLeasse'=>$viewLeasse,'viewPr'=>$viewPr,'viewRP'=>$viewRP,'getType'=>$getType[0]['type'],'generalInfo'=>$generalInfo,'instrumentType'=>$getType[0]['InstrumentType']));
		...
		public function viewLeaseAction(Request $request,$id)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:viewLease.html.twig',array('viewLease'=>$viewLease,'viewLessor'=>$viewLessor,'viewLeasse'=>$viewLeasse,'viewPr'=>$viewPr,'viewRP'=>$viewRP,'getType'=>$getType[0]['type'],'generalInfo'=>$generalInfo));
		...
		public function showRegistrationTypeAction(Request $request)
		{
			...
			foreach($regType as $registration)
			{
				...
				$html.='<a href="'.$url.$registration['property_type'].'/'.$registration['code'].'/registrarAdmin">'.$registration['type'].'</a>';
		...
		public function propertiesAction(Request $request,$code)
		{
			...
			$em = $this->getDoctrine()->getEntityManager();
			$properties = $em->createQueryBuilder()
			->select('properties.lomp,properties.id,properties.serial_number,rStatus.status,properties.lessor,properties.lessee,properties.grantor,properties. 	grantee,properties.stamp_duty,properties.registrar_general_initial,properties.registering_party,properties.or_number,properties.execution_date,properties.receipt_date,properties.reference_number,properties.recipient,properties.land_situation,properties.id,rtype.type')
			->from('DRPAdminBundle:Book',  'properties')
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:lease.html.twig',array('properties'=>$arrAllProperties,'b'=>$code));
			...
			//echo"<pre>";print_r($properties);die;
				...
				return $this->render('DRPRegistrarAdminBundle:Pages:drb.html.twig',array('properties'=>$arrAllProperties,'code'=>$code));
...
//echo "<PRE>";print_r($lastTransaction);die;
	...
	function addSearchesAction(Request $request )
	{
		...
		if($request->getMethod() == 'POST') 
		{
			...
			->getResult();
			 ...
			 return $this->redirect($this->generateUrl('registrarAdmin_searchQuota'));

		}
		return $this->render('DRPRegistrarAdminBundle:Pages:addSearches.html.twig');
	...
	function removeSearchesAction(Request $request)
	{
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:removeSearches.html.twig');
	...
	function manageAdminAction(Request $request)
	{
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:manageAdmin.html.twig',array('admin'=>$admin));
	}
	...
	function manageGeneralAction(Request $request)
	{
			...
			->getQuery()
			->getResult();
		return $this->render('DRPRegistrarAdminBundle:Pages:manageGeneral.html.twig',array('general'=>$general));
	}		
	function addAdminAction(Request $request)
	{
		...
		if($request->getMethod() == 'POST') 
		{
			...
			return $this->redirect($this->generateUrl('registrarAdmin_admin'));

		}	
		return $this->render('DRPRegistrarAdminBundle:Pages:addAdmin.html.twig');
	}	
	function addGeneralAction(Request $request)
	{
		...
		if($request->getMethod() == 'POST') 
		{
			...
			return $this->redirect($this->generateUrl('registrarAdmin_general'));
		}
	
		return $this->render('DRPRegistrarAdminBundle:Pages:addGeneral.html.twig');
	}	
	...
	function editGeneralAction(Request $request,$id)
	{
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:editGeneral.html.twig',array('editGeneral'=>$editGeneral));
	}	
	...
	function editAdminAction(Request $request,$id)
	{
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:editAdmin.html.twig',array('editAdmin'=>$editAdmin));
	}
	...
	public function viewGeneralAction(Request $request,$id)
	{
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:viewGeneral.html.twig',array('viewGeneral'=>$viewGeneral));
	}
	...
	public function viewAdminAction(Request $request,$id)
	{
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:viewAdmin.html.twig',array('viewAdmin'=>$viewAdmin));
	...
	public function leaseRegistrationTypeAction(Request $request)
	{
		...
		$em = $this->getDoctrine()->getEntityManager();
			...
			->getQuery()
			->getResult();
			return $this->render('DRPRegistrarAdminBundle:Pages:leaseRegistrationType.html.twig',array('registrationType'=>$registrationType));
	...
	public function viewDetailAction(Request $request,$id)
	{
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:viewDetail.html.twig',array('viewDetail'=>$viewDetail,'type'=>$viewDetail[0]['property_type']));
	}	
...
/*===========Pdf Code Starts Here============*/
		...
		public function genratePdfLeaseAction(Request $request,$code)
		{
			...
			$html.= $this->render('DRPRegistrarAdminBundle:Pages:lease.html.twig',array('properties'=>$arrAllProperties,'b'=>$code));
...
$typeR = $em->getRepository('DRPAdminBundle:RegistrationType')->findOneBy(array('code'=>$code));
				...
				$html.= '<img style="width:20%;margin-left:38%;"src='.$url.'><br>';
				$html.='<h3 style="text-align:center;">Records of '.$typeR->type.' </h3>';
				$html.=  $this->render('DRPRegistrarAdminBundle:Pages:drb.html.twig',array('properties'=>$arrAllProperties,'code'=>$code));
$html.= '<style>.navbar-collapse.collapse {
   				 display: hidden !important;
...
/*========Pdf Code Ends Here============*/
		...
		public function transactionReportsAction(Request $request)
		{
				...
				return $this->render('DRPRegistrarAdminBundle:Pages:transactionReports.html.twig');
		}
		...
		public function resultAction(Request $request)
		{
			...
			//echo"<pre>";print_r($searchProperties);die;
				...
				else
				{
					...
					$params['description'] = $this->getLogEventDescriptionAction('ADMIN_SEARCH');
					$params['userId'] =$session->get('userId');
					$params['ipAddress'] = $ipAddress;
					$params['creatorId'] = $session->get('userId');
					$this->setLogAction($params);
					return $this->render('DRPRegistrarAdminBundle:Pages:result.html.twig',array('searchProperties'=>$arrAllProperties));
		...
		public function addDocumentsAction(Request $request)
	{
		...
		if ($request->getMethod() == 'POST')
		 ...
		 return $this->render('DRPRegistrarAdminBundle:Pages:addDocuments.html.twig',array('message'=>$message));	

		}		

		 return $this->render('DRPRegistrarAdminBundle:Pages:addDocuments.html.twig');	
	...
	public function addDrbDocumentsAction(Request $request)
		...
		if ($request->getMethod() == 'POST')
			...
			$em->persist($document);
			$em->flush();
			 return $this->render('DRPRegistrarAdminBundle:Pages:addDrbDocuments.html.twig',array('message'=>$message));	
		}		

		 return $this->render('DRPRegistrarAdminBundle:Pages:addDrbDocuments.html.twig');	
		...
		public function viewTransactionDetailAction(Request $request,$id)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:viewTransaction.html.twig',array('viewLease'=>$viewLease,'viewLessor'=>$viewLessor,'viewLeasse'=>$viewLeasse,'viewPr'=>$viewPr,'viewRP'=>$viewRP,'getType'=>$getType[0]['type'],'generalInfo'=>$generalInfo,'instrument'=>$instrument,'viewgrantor'=>$viewgrantor,'viewgrantee'=>$viewgrantee));


		}

	/*============Search Code starts from here Similar to user ===================*/
	...
	public function searchLeaseAction(Request $request,$code)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:showLease.html.twig',array('type'=>$searchProperties,'code'=>$code));
		...
		public function searchRegistrationTypeAction(Request $request)
		{
			...
			foreach($regType as $registration)
			{
				...
				$html.='<a href="'.$url.$registration['property_type'].'/search/registrarAdmin/'.$registration['code'].'">'.'Search '.$registration['type'].'</a>';
		...
		return $this->render('DRPRegistrarAdminBundle:Pages:searchDrb.html.twig',array('properties'=>$searchProperties,'type'=>$code,'searchProperties'=>$arrAllProperties,'code'=>$type,'instrumentType'=>$instrumentType));
			...
			public function searchDrbAction(Request $request,$code)
			{
				...
				return $this->render('DRPRegistrarAdminBundle:Pages:showDrb.html.twig',array('type'=>$searchProperties,'code'=>$code,'instrumentType'=>$instrumentType));
		...
		public function userLeaseDocumentsAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:userLeaseDocuments.html.twig',array('documents'=>$documents));
		...
		public function userDRBDocumentsAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:userDRBDocuments.html.twig',array('documents'=>$documents));

		}



		/*============Search Code Ends here Similar to user ===================*/
		...
		public function globalLeaseAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:globalLease.html.twig');
		...
		public function resultGlobalLeaseAction(Request $request)
		{
			...
			if($request->getMethod() == 'POST') 
			{
				...
				return $this->render('DRPRegistrarAdminBundle:Pages:globalResultLease.html.twig',array('searchProperties'=>$searchProperties));
			}
		...
		public function globalDRBAction(Request $request)
		{
			...
			return $this->render('DRPRegistrarAdminBundle:Pages:globalDRB.html.twig');
		...
		public function resultGlobalDRBAction(Request $request)
		{
			...
			if($request->getMethod() == 'POST') 
			{
				...
				->select('rType.type,properties.id,properties.reference_number,properties.execution_date 	receipt_date,properties.execution_date,properties.lomp,properties.serial_number,properties.land_situation,properties.or_number,grantee.first_name as granteeName,grantee.last_name as granteeLast,grantor.first_name as grantorName,grantor.last_name as grantorLast,grantee.nin as granteeNIN,grantor.nin as grantorNIN,pr.first_name as prName,pr.last_name as prLast,pr.nin as prNIN,rp.first_name as rpName,rp.last_name as rpLast,rp.nin as rpNIN')
					...
					$params['creatorId'] = $session->get('userId');
					$this->setLogAction($params);
					return $this->render('DRPRegistrarAdminBundle:Pages:resultGlobalDRB.html.twig',array('searchProperties'=>$searchProperties));
			}
